import { getSessionDates } from './sheets'
import { getSessionOverrides } from './events'
import sql from './db'
...
// Returns today's date in MVT as 'YYYY-MM-DD'
export function getTodayMVT(): string {
...
export async function getCalendarDays(month: string): Promise<CalendarDay[]> {
