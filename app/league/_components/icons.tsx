/* Hand-rolled inline SVG icons (Hallmark P2 2e — lucide-react dropped).
   Same 24×24 viewBox / stroke-width 2 voice as the federation site's inline
   icons. Props mirror the old lucide call sites: `size` + `className`. */
